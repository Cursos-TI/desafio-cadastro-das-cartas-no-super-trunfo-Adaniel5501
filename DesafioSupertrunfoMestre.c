...
// terceira parte do desafio Mestre
...
*/
  ...
  // Cálculo da densidade populacional
    densidade_populacional_1 = populacao_1 / area_em_km2_1;
    ...
    super_poder_1 = populacao_1 + area_em_km2_1 + pib_1 + pontos_turisticos_1 + pib_per_capita_1 + (1.0 / densidade_populacional_1);
    super_poder_2 = populacao_2 + area_em_km2_2 + pib_2 + pontos_turisticos_2 + pib_per_capita_2 + (1.0 / densidade_populacional_2);
